...
This tutorial is heavily adapted from [Datacamp Intro to SQL course](https://github.com/datacamp/courses-intro-to-sql)

## [Selecting Columns](https://github.com/Nikronic/DBLab/blob/master/DBLab.wiki/Examples.md#selecting-columns)

11. [Selecting Single Columns](https://github.com/Nikronic/DBLab/blob/master/DBLab.wiki/Examples.md#selecting-single-column)
...
## [Filtering Rows](https://github.com/Nikronic/DBLab/blob/master/DBLab.wiki/Examples.md#filtering-rows)
...
## [Aggregate Functions](https://github.com/Nikronic/DBLab/blob/master/DBLab.wiki/Examples.md#aggregate-functions)
...
## [Sorting, Grouping](https://github.com/Nikronic/DBLab/blob/master/DBLab.wiki/Examples.md#sorting-grouping)
